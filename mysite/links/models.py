...
class Link_Topic(models.Model):   
    link_topic_text = models.CharField(max_length=200, blank=True, null=True)       

    def __unicode__(self):
        return self.link_topic_text
...
class Link(models.Model):  
    ...
    link_text = models.TextField(max_length=200, blank=True, null=True, verbose_name="Notice ")  
    link_topic = models.ForeignKey(Link_Topic,blank=True, null=True) 
    ...
    link_url_1 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Link URL 1 ")  
    link_url_2 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Link URL 2 ")  
    link_url_3 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Link URL 3 ")  
    link_url_4 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Link URL 4 ")  
    link_url_5 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Link URL 5 ")  

    video_url_1 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Video URL 1 ")  
    video_url_2 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Video URL 2 ")  
    video_url_3 = models.CharField(max_length=200, blank=True, null=True, verbose_name="Video URL 3 ")  
       


    image1 = models.ImageField(upload_to='images/link/', blank=True, null=True)
    image2 = models.ImageField(upload_to='images/link/', blank=True, null=True)
    image3 = models.ImageField(upload_to='images/link/', blank=True, null=True)

    file1 = models.FileField(upload_to='files/link/', blank=True, null=True)
    file2 = models.FileField(upload_to='files/link/', blank=True, null=True)
    file3 = models.FileField(upload_to='files/link/', blank=True, null=True)
